...
pub fn post_job_duties(state: JobState, tombstone: bool, failure_mode: &str) -> Option<bool> {
    if tombstone {
        return None;
    }
...
pub fn auto_retry_eligible(j: &Job, secs: u64) -> bool {
    secs > 0
...
pub fn post_job_plan(j: &Job, failure_mode: &str, auto_retry_secs: u64) -> Option<bool> {
...
pub fn merge_notify_tokens(list: &mut [crate::notify::Target], old: &[crate::notify::Target]) {
