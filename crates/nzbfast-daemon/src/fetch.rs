...
pub fn content_disposition_filename(hdr: &str) -> Option<String> {
...
pub fn name_from_fetch(f: &Fetched, url: &str) -> Option<String> {
...
pub fn pick_failure_link(canonical: &str, alias: &str) -> String {
...
pub use nzbkit::urlauth::url_host;
pub use nzbkit::urlauth::url_netloc;
...
pub fn supplied_link_scheme_ok(link: &str, origin_url: &str) -> bool {
...
pub fn failure_link_allowed(link: &str, origin_host: &str, origin_https: bool) -> bool {
...
/// FailureLink applies.
pub fn is_nzb_body(bytes: &[u8]) -> bool {
...
pub fn replacement_inherits(j: &Job) -> (String, i32, Option<String>) {
...
pub fn may_regrab(mode: &str, depth: u8) -> bool {
...
pub fn fetch_url_from(url: &str, origin: &SourceOrigin) -> Result<Fetched> {
