...
pub(crate) const SEARCH_LOG_BUFFER: usize = 4_000;

/// How long a bucket survives without being asked again.
pub const SEARCH_LOG_DAYS: i64 = 30;
...
pub const SEARCH_LOG_ROWS: u32 = 5_000;
...
impl Daemon {
    ...
    /// already empty.
    #[cfg(feature = "indexer")]
    pub fn clear_search_log(&self) -> Result<usize, IndexBusy> {
    ...
    #[cfg(feature = "indexer")]
    pub fn clear_search_log_deferred(&self) {
