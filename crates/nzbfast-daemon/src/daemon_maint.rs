...
//! `pub(super)` became `pub(crate)` for that reason - `super`
...
impl MaintenanceArm {
    ...
    pub fn arm(&self, handle: nzbkit::index::InterruptHandle) -> bool {
...
#[cfg(feature = "indexer")]
pub async fn abort_compact_when_job_starts(
...
#[cfg(feature = "indexer")]
pub const COMPACT_ABORT_POLL_MS: u64 = 100;
...
/// and resumable.
#[cfg(feature = "indexer")]
pub const COMPACT_CHUNK_PAGES: u32 = 2048;
...
impl Daemon {
    ...
    #[cfg(feature = "indexer")]
    pub fn index_maintenance_ok(&self) -> bool {
    ...
    #[cfg(feature = "indexer")]
    pub fn db_maintenance_ok(&self) -> bool {
