...
#[cfg(feature = "indexer")]
pub fn person_photo_url(art_dir: &std::path::Path, id: i64) -> String {
...
#[cfg(feature = "indexer")]
pub fn make_thumb(src: &[u8]) -> Option<Vec<u8>> {
...
pub fn window_of(params: &std::collections::HashMap<String, String>) -> (usize, usize) {
    let num = |k: &str| {
        params
            .get(k)
...
pub fn in_window(rank: usize, (start, limit): (usize, usize)) -> bool {
