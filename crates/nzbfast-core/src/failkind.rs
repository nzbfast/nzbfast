...
//!
//! It sat in `job_fail.rs` until TODO 276 item 3, and that was
...
//! daemon concern and never was. `job_fail.rs` keeps the half
...
impl FailKind {
    ...
    pub fn post_unavailable(self) -> bool {
...
pub fn disk_full_failure(msg: &str) -> bool {
...
pub fn disk_full_mid_download(msg: &str) -> bool {
...
pub fn fail_kind_token(k: FailKind) -> &'static str {
    match k {
...
pub fn kind_from_token(tok: &str) -> Option<FailKind> {
    match tok {
...
pub const RETRY_WHY_TRANSPORT: &str = "transport";
pub const RETRY_WHY_PROPAGATION: &str = "propagation";
...
pub fn fail_hint(msg: &str) -> &'static str {
...
pub fn fail_action(kind: FailKind, hint: &str, msg: &str, password_required: bool) -> &'static str {
...
/// have served for it.
pub fn fail_kind_of(code: Option<FailCode>, msg: &str) -> FailKind {
    match code {
...
pub fn job_kind(code: Option<FailKind>, msg: &str) -> FailKind {
...
impl Classified {
    pub fn new(kind: FailKind, message: String) -> Self {
...
pub fn code_of_error(e: &anyhow::Error) -> Option<FailKind> {
    e.chain()
        .find_map(|c| c.downcast_ref::<Classified>())
        .map(|c| c.kind)
}

pub fn fail_kind(msg: &str) -> FailKind {
