...
//!
//! Its own file because it is its own subject: a hundred lines of
//! prose and a framing walk, which is the shape every child of
//! par2repair.rs has. The reason RECORDED when it was written was the
//! size gate - par2repair.rs was against its ceiling and could not hold
//! them - and that half has expired: the 31 Aug 2026 recalibration and
//! then the 1 Sep 2026 split left it 1,413 clear, measured that day.
//! The subject argument is what keeps it here. Reachable through
//! `super::*` like every other child.
