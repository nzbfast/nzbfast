...
pub(super) struct PreLock {
    ...
    pub(super) alt_held: Vec<crate::altcand::HeldSpare>,
    ...
    pub(super) pause_cost: Vec<(String, crate::requeue::RequeueCost)>,
}
...
pub(super) fn prelock_reads(d: &Daemon) -> PreLock {
    ...
    let disk_now = disk_stat_walk(&crate::naming::out_dir(d));
