...
pub(crate) struct UnpackOutcome {
    pub(crate) spent: Vec<PathBuf>,
    pub(crate) packed: Vec<PackedGroup>,
}
...
pub(crate) fn judge(packed: &[PackedGroup], covered: Option<&HashSet<String>>) -> VouchVerdict {
...
pub(crate) fn failure_sentence(names: &[String]) -> String {
    format!(
