...
impl Daemon {
    ...
    pub(in crate::serve) fn fold_bytes_by_host(per: &[(String, u64)]) -> Vec<(String, u64)> {
    ...
    pub(in crate::serve) fn block_pool_rules(
        &self,
...
/// and 5.3.
pub(in crate::serve) const BLOCK_LOW_PCT: u64 = 85;
...
pub(in crate::serve) struct BlockStanding {
    pub host: String,
...
impl BlockStanding {
    ...
    pub(in crate::serve) fn pct(&self) -> f64 {
        if self.total == 0 {
            return 0.0;
        }
    ...
    pub(in crate::serve) fn band(&self) -> u8 {
        if self.total == 0 {
            0
    ...
    pub(in crate::serve) fn band_word(&self) -> &'static str {
        match self.band() {
            2 => "spent",
            1 => "low",
            _ => "ok",
...
impl Daemon {
    ...
    pub(in crate::serve) fn block_standing(
        &self,
    ...
    pub(in crate::serve) fn block_standings(
        &self,
    ...
    /// read the file.
    pub(in crate::serve) fn block_threshold_tick(&self) {
