...
pub(crate) struct ContestedName {
...
impl NameVotes {
    ...
    /// like any other.
    pub(crate) fn resumed(seed: &[(String, u32)]) -> Self {
...
impl FileSlot {
    ...
    pub(crate) fn contested_records(&self, yenc_name: &str) -> Vec<(String, u32)> {
        use std::sync::atomic::Ordering::Relaxed;
    ...
    pub(crate) fn contested_yenc_name(&self) -> Option<ContestedName> {
        use std::sync::atomic::Ordering::Relaxed;
