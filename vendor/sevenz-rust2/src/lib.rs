...
#[cfg(feature = "util")]
mod util;
/// Where the AES writer options draw their salt and initialisation
/// vector. nzbfast local change - see `README-nzbfast.md`.
#[cfg(all(feature = "aes256", feature = "compress"))]
pub mod write_entropy;
...
pub use writer::*;
#[cfg(all(feature = "aes256", feature = "compress"))]
pub use write_entropy::{Entropy, EntropyScope};
