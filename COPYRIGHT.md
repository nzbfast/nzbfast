...
|---|---|---|
| **rapidyenc** 1.1.1 (SIMD yEnc codec) | `crates/nzbkit-base/vendor/rapidyenc/`, compiled into nzbfast | Public domain / CC0 - no attribution obligation |
| **crcutil** | `crates/nzbkit-base/vendor/rapidyenc/crcutil-1.0/` | Apache Licence 2.0. **Not compiled into nzbfast** (the build sets `YENC_DISABLE_CRCUTIL=1`); present only because it is part of the upstream snapshot |
